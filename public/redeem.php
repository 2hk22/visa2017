    ...
    else
    {
        ...
        $sql = 'SELECT
                ...
                FROM
                    `merchants`
                WHERE
                    code LIKE :merchant_code';
        $stmt = $db->prepare($sql);
        $stmt->bindParam(':merchant_code', $_GET['merchant_code']);
        $stmt->execute();
        $merchant = $stmt->fetch();
            ...
            <div class="col-sm-12 col-md-8 col-md-offset-2">
                <div class="push-100-t">
                    ...
                    <form class="form-horizontal push-30-t" id="redeeem_form" action="redeem-submit.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for="spending">Your Purchase Amount (THB)</label>
                            <input class="form-control" type="text" id="spending" name="spending" placeholder="Enter Purchase Amount (THB).." required />
                        </div>
                        <div class="form-group">
                            <label for="approval_code">Approval code on Visa sale slip</label>
                            <input class="form-control" type="text" id="approval_code" name="approval_code" placeholder="Enter Approval Code.." required />
                        </div>
